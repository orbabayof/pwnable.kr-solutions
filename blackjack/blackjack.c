...
// Feel free to use any and all parts of this program and claim it as your own
// work
...
// Global Variables
int k;
int // Programmer: Vladislav Shulman
// Final Project
// Blackjack
...
void cash_test();   // Test for if user has cash remaining in purse
void askover();     // Asks if user wants to continue playing
void fileresults(); // Prints results into Blackjack.txt file in program
                    // directory
...
int main(void) {
  ...
  printf("\n%c%c%c%c%c     %c%c            %c%c         %c%c%c%c%c    %c    %c "
         "               ",
         club, club, club, club, club, spade, spade, diamond, diamond, heart,
         heart, heart, heart, heart, club, club);
  printf("\n%c    %c    %c%c           %c  %c       %c     %c   %c   %c        "
         "      ",
         club, club, spade, spade, diamond, diamond, heart, heart, club, club);
  printf("\n%c    %c    %c%c          %c    %c     %c          %c  %c          "
         "     ",
         club, club, spade, spade, diamond, diamond, heart, club, club);
  printf("\n%c%c%c%c%c     %c%c          %c %c%c %c     %c          %c %c      "
         "        ",
         club, club, club, club, club, spade, spade, diamond, diamond, diamond,
         diamond, heart, club, club);
  printf("\n%c    %c    %c%c         %c %c%c%c%c %c    %c          %c%c %c     "
         "        ",
         club, club, spade, spade, diamond, diamond, diamond, diamond, diamond,
         diamond, heart, club, club, club);
  printf("\n%c     %c   %c%c         %c      %c    %c          %c   %c         "
         "      ",
         club, club, spade, spade, diamond, diamond, heart, club, club);
  printf("\n%c     %c   %c%c        %c        %c    %c     %c   %c    %c       "
  ...
  printf("\n%c%c%c%c%c%c    %c%c%c%c%c%c%c   %c        %c     %c%c%c%c%c    %c "
         "    %c            ",
         club, club, club, club, club, club, spade, spade, spade, spade, spade,
         spade, spade, diamond, diamond, heart, heart, heart, heart, heart,
         club, club);
  printf("\n");
  printf("\n                        21                                   ");
  ...
  printf("\n        %c%c       %c    %c     %c          %c  %c               ",
         diamond, diamond, heart, heart, club, spade, spade);
  printf("\n        %c%c       %c %c%c %c     %c          %c %c              ",
         diamond, diamond, heart, heart, heart, heart, club, spade, spade);
  printf(
      "\n        %c%c      %c %c%c%c%c %c    %c          %c%c %c             ",
      diamond, diamond, heart, heart, heart, heart, heart, heart, club, spade,
      spade, spade);
  printf("\n        %c%c      %c      %c    %c          %c   %c               ",
         diamond, diamond, heart, heart, club, spade, spade);
  printf(
      "\n     %c  %c%c     %c        %c    %c     %c   %c    %c             ",
      diamond, diamond, diamond, heart, heart, club, spade, spade);
  printf("\n      %c%c%c      %c        %c     %c%c%c%c%c    %c     %c         "
         "   ",
         diamond, diamond, diamond, heart, heart, club, club, club, club, club,
         spade, spade);
  printf("\n");
  printf("\n         222                     111                         ");
  printf("\n        222                      111                         ");
...
void asktitle() // Function for asking player if they want to continue
{
  ...
  while ((choice1 != 'Y') && (choice1 != 'y') && (choice1 != 'N') &&
         (choice1 != 'n')) // If invalid choice entered
  {
    printf("\n");
    printf("Incorrect Choice. Please Enter Y for Yes or N for No.\n");
    scanf("%c", &choice1);
...
void rules() // Prints "Rules of Vlad's Blackjack" list
{
  ...
  printf("\nIII.");
  printf("\n     After the dealing of the first two cards, YOU must decide "
         "whether to HIT or STAY.");
  printf("\n      %c Staying will keep you safe, hitting will add a card.",
         spade);
  printf("\n     Because you are competing against the dealer, you must beat "
         "his hand.");
  printf("\n     BUT BEWARE!.");
  printf("\n      %c If your total goes over 21, you will LOSE!.", diamond);
  printf(
      "\n     But the world is not over, because you can always play again.\n");
  printf("\n%c%c%c YOUR RESULTS ARE RECORDED AND FOUND IN SAME FOLDER AS "
         "PROGRAM %c%c%c\n",
         spade, heart, club, club, heart, spade);
  printf("\nWould you like to go the previous screen? (I will not take NO for "
         "an answer)");
  printf("\n                  (Y/N)\n                    ");
  scanf("\n%c", &choice1);
  ...
  if ((choice1 == 'Y') || (choice1 == 'y')) // If yes, continue. Prints menu.
  {
    ...
    asktitle();
           ...
           (choice1 == 'n')) // If no, convinces user to enter yes
  {
    system("cls");
    printf("\n                 I told you so.\n");
    asktitle();
...
int clubcard() // Displays Club Card Image
{
  ...
  if (k == 11) // If random number is 11, print card with A (Ace) on face
  {
    ...
    printf("|    %c|\n", club);
    printf("-------\n");
    if (player_total <= 10) // If random number is Ace, change value to 11 or 1
...
int spadecard() // Displays Spade Card Image
{
  ...
  if (k == 11) // If random number is 11, print card with A (Ace) on face
  {
    ...
    else // Programmer: Vladislav Shulman
// Final Project
// Blackjack
...
void play() // Plays game
{
  ...
  while (i <= 21) // While loop used to keep asking user to hit or stay at most
                  // twenty-one times
                  ...
                  //   consecutive 1's
  {
    ...
    if (p <= 21) // If player total is less than 21, ask to hit or stay
    {
      ...
      scanf("%c", &choice3);
      while ((choice3 != 'H') && (choice3 != 'h') && (choice3 != 'S') &&
             (choice3 != 's')) // If invalid choice entered
      {
        printf("\n");
        printf("Please Enter H to Hit or S to Stay.\n");
        scanf("%c", &choice3);
    ...
    i++; // While player total and dealer total are less than 21, re-do while
         // loop
  } // End While Loop
} // End Function
...
void dealer() // Function to play for dealer AI
{
  ...
  if (dealer_total < 17) {
    srand((unsigned)time(NULL) + 1); // Generates random seed for rand()
                                     // function
    z = rand() % 13 + 1;
    if (z <= 10) // If random number generated is 10 or less, keep that value
    {
    ...
    if (z >
        11) // If random number generated is more than 11, change value to 10
    {
      d = 10;
    }
...
void stay() // Function for when user selects 'Stay'
{
  ...
  if (dealer_total >= 17) {
    if (player_total >=
        dealer_total) // If player's total is more than dealer's total, win
    {
      printf("\nUnbelievable! You Win!\n");
      won = won + 1;
      cash = cash + bet;
    ...
    if (player_total <
        dealer_total) // If player's total is less than dealer's total, loss
    {
      printf("\nDealer Has the Better Hand. You Lose.\n");
      loss = loss + 1;
      cash = cash - bet;
...
void cash_test() // Test for if user has cash remaining in purse
{
  if (cash <= 0) // Once user has zero remaining cash, game ends and prompts
                 // user to play again
  {
    printf("You Are Bankrupt. Game Over");
    cash = 500;
